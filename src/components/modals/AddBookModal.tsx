    ...
    <Modal onClose={onClose} labelledBy="add-book-modal-title">
      <div className={MODAL_PANEL}>
        ...
        <div className={MODAL_BODY}>
          ...
          {loading && (
            <div className="text-center py-5 text-dim text-xs sm:text-[13px] after:content-[''] after:inline-block after:w-3.5 after:h-3.5 after:border-2 after:border-border after:border-t-accent after:rounded-full after:ml-2 after:align-middle after:animate-spin">
              검색중
            </div>
          )}
          {error && (
          ...
          <div className="text-center my-5 text-dim text-xs sm:text-[13px]">— 또는 —</div>
