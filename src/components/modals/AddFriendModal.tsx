    ...
    <Modal onClose={onClose} labelledBy="add-friend-modal-title">
      <div className={MODAL_PANEL}>
        ...
        <div className={MODAL_BODY}>
          <div className="flex items-center gap-2 px-3 rounded-lg bg-surface2 border border-border focus-within:outline focus-within:outline-2 focus-within:outline-accent focus-within:outline-offset-[-1px]">
