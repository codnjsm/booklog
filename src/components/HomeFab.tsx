    ...
    <div className="sm:hidden">
      ...
      <div className="fixed z-[95] bottom-[calc(75px+env(safe-area-inset-bottom))] right-4 flex flex-col items-end gap-4">
        ...
        <button
          ...
          className="w-14 h-14 rounded-full bg-[var(--fab-soft)] text-accent border-none cursor-pointer shadow-fab flex items-center justify-center text-3xl font-light leading-none transition-transform duration-200"
