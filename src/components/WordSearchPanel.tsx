...
export default function WordSearchPanel({ words, onAddWord }: Props) {
  ...
  return (
    <div className="bg-surface border border-border rounded-lg overflow-hidden focus-within:outline focus-within:outline-2 focus-within:outline-accent focus-within:outline-offset-[-1px]">
